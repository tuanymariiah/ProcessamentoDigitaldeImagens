...
for k = 1:1
  ...
  dominocolorido = imread(strcat('C:\Users\Tuany Mariah\Desktop\aquisicaoDomino\',nomeImagem));
  ...
  [rotulo,qtdD] = bwlabel(erodir1); 
  vetor = unique(rotulo);
  pSep = separaObjetos(rotulo,vetor,qtdD);
  disp(qtdD)
  
  domino = segmentacao(dominocolorido, A, erodir1);
