...
cont =1;
for k = 1:5
  nomeImagem = strcat('img (',num2str(k),').jpg');
  ...
  teste = regionprops(pSep);
  #disp(teste);
  #disp('Quantidade de Domino')
  #disp(qtdD)
  descritores = zeros(qtdD,1);
  ...
  for i=1:qtdD
   ...
   erodirboliha3 = erode(erodirboliha2);
   figure('name','imagem domino separada e erodida 4 vez'), imshow(erodirboliha3)
   
   [rotuloP,qtdP] = bwlabel(erodirboliha3); #rotular e contar objetos
   ...
   #saida = strcat('saida (',num2str(i),').jpg');
